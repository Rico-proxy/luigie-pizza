...
const Second = () => {
  ...
  return (
    ...
    <section id='about' data-aos-anchor-placement="top-bottom" className=" md:grid grid-cols-2 px-5 md:p-16 ">
          <div data-aos="fade-down"
     data-aos-offset="100"
     data-aos-easing="ease-in-sine"
     data-aos-delay="50"
      className="space-y-4 genos md:text-2xl text-white">
                ...
                <button className='hidden font-bold hover:bg-black md:block hover:border hover:border-red-200 hover:text-red-200  rounded-2xl py-1 px-6  bg-white text-black border-red-200 border-4'>
                  <Link href='#'>MENU</Link>
                </button>
          </div>
          <div>
